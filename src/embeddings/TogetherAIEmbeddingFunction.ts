...
export class TogetherAIEmbeddingFunction implements IEmbeddingFunction {
    ...
    constructor({ openai_api_key, openai_model, openai_organization_id, openai_baseURL }: {
        ...
        this.baseURL = openai_baseURL || "https://api.together.xyz/";
    }
    ...
    private async loadClient() {
        ...
        try {
            const { openai, version } = await TogetherAIEmbeddingFunction.import();
            OpenAIApi = openai;
